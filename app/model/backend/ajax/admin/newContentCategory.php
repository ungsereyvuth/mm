...
class newContentCategory{
	public function data($data){
		...
		$opt_fields = array('recordid','active');
		...
		if(!count($err_fields)){			
			...
			if(!count($err_fields)){
				...
				if($check_exist){$msg='Duplicate category code';$err_fields[]= array('name'=>'code','msg'=>$msg);}
			}
		}
