...
<section class="section">
  ...
  <section class="section section-xs bg-gray-100 text-center">
        <div class="container">
          ...
          <?=$nearby?>
          </div><a class="button button-1 wow fadeIn v_mgn25" href="/<?=$pageData->lang->selected.$pageData->label->menu->events_list->url?>"><?=$pageData->label->label->see_all->title?></a>
        </div>
      </section>
<?php
