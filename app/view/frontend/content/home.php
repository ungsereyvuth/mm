	  ...
	  <div class="card card-2col flex-fill">
		...
		<div class="d-flex flex-column-reverse flex-md-row">
		  ...
		  <div class="card-2col-img">
			...
			<div data-cover="/assets/frontend/template/img/categories/men.jpg" data-xs-height="120px" data-sm-height="200px" data-md-height="175px" data-lg-height="225px" data-xl-height="250px"></div>
	  ...
	  <div class="card card-2col flex-fill">
		...
		<div class="d-flex flex-column-reverse flex-md-row">
		  ...
		  <div class="card-2col-img">
			...
			<div data-cover="/assets/frontend/template/img/categories/women.jpg" data-xs-height="120px" data-sm-height="200px" data-md-height="175px" data-lg-height="225px" data-xl-height="250px"></div>
  ...
  <div class="row gutters-3 mt-3">
	...
	<div class="col-6">
	  ...
	  <div class="card card-2col text-white zoom-hover">
		...
		<img class="card-img" src="/assets/frontend/template/img/categories/sunglasses.jpg" alt="Card image">
	...
	<div class="col-6">
	  ...
	  <div class="card card-2col text-white zoom-hover">
		...
		<img class="card-img" src="/assets/frontend/template/img/categories/backpack.jpg" alt="Card image">
				...
				<div class="card card-2col shadow-none">
				  ...
				  <div class="d-flex flex-column-reverse flex-md-row">
					...
					<div class="card-2col-img">
					  ...
					  <a href="shop-single.html" data-cover="/assets/frontend/template/img/products/flash_deals_1.jpg" data-xs-height="250px" data-sm-height="200px" data-md-height="175px" data-lg-height="225px" data-xl-height="250px"></a>
				...
				<div class="card card-2col shadow-none">
				  ...
				  <div class="d-flex flex-column-reverse flex-md-row">
					...
					<div class="card-2col-img">
					  ...
					  <a href="shop-single.html" data-cover="/assets/frontend/template/img/products/flash_deals_2.jpg" data-xs-height="250px" data-sm-height="200px" data-md-height="175px" data-lg-height="225px" data-xl-height="250px"></a>
	...
	<div class="col-sm-6 col-md-4">
	  ...
	  <a href="shop-grid.html">
		...
		<div class="card zoom-hover">
		  ...
		  <div data-cover="/assets/frontend/template/img/discover/1.jpeg" data-xs-height="150px" data-sm-height="272px" data-md-height="246px" data-lg-height="324px" data-xl-height="400px"></div>
		...
		<div class="col-6 col-sm-12 mt-3 mt-sm-0">
		  ...
		  <a href="shop-grid.html">
			...
			<div class="card zoom-hover">
			  ...
			  <div data-cover="/assets/frontend/template/img/discover/2.jpeg" data-xs-height="100px" data-sm-height="128px" data-md-height="115px" data-lg-height="154px" data-xl-height="192px"></div>
		...
		<div class="col-6 col-sm-12 mt-3">
		  ...
		  <a href="shop-grid.html">
			...
			<div class="card zoom-hover">
			  ...
			  <div data-cover="/assets/frontend/template/img/discover/3.jpeg" data-xs-height="100px" data-sm-height="128px" data-md-height="115px" data-lg-height="154px" data-xl-height="192px"></div>
		...
		<div class="col-6 col-md-12 mt-3 mt-md-0">
		  ...
		  <a href="shop-grid.html">
			...
			<div class="card zoom-hover">
			  ...
			  <div data-cover="/assets/frontend/template/img/discover/4.jpeg" data-xs-height="100px" data-sm-height="128px" data-md-height="115px" data-lg-height="154px" data-xl-height="192px"></div>
		...
		<div class="col-6 col-md-12 mt-3">
		  ...
		  <a href="shop-grid.html">
			...
			<div class="card zoom-hover">
			  ...
			  <div data-cover="/assets/frontend/template/img/discover/5.jpeg" data-xs-height="100px" data-sm-height="128px" data-md-height="115px" data-lg-height="154px" data-xl-height="192px"></div>
  ...
  <div class="card-deck card-deck-product mt-3 mb-2 mb-sm-0">
	...
	<div class="card card-product">
	  ...
	  <div class="card-body">
		...
		<a href="shop-single.html"><img class="card-img-top" src="/assets/frontend/template/img/products/1_small.jpg" alt="Card image cap"></a>
	...
	<div class="card card-product">
	  ...
	  <div class="card-body">
		...
		<a href="shop-single.html"><img class="card-img-top" src="/assets/frontend/template/img/products/2_small.jpg" alt="Card image cap"></a>
		...
		<div class="color-options">
		  ...
		  <label class="custom-control custom-radio custom-radio-color custom-control-inline">
			...
			<input type="radio" name="color-option1" class="custom-control-input" value="/assets/frontend/template/img/products/2_small.jpg" checked>
		  ...
		  <label class="custom-control custom-radio custom-radio-color custom-control-inline">
			...
			<input type="radio" name="color-option1" class="custom-control-input" value="/assets/frontend/template/img/products/2_small_black.jpg">
		  ...
		  <label class="custom-control custom-radio custom-radio-color custom-control-inline">
			...
			<input type="radio" name="color-option1" class="custom-control-input" value="/assets/frontend/template/img/products/2_small_red.jpg">
	...
	<div class="card card-product">
	  ...
	  <div class="card-body">
		...
		<a href="shop-single.html"><img class="card-img-top" src="/assets/frontend/template/img/products/3_small.jpg" alt="Card image cap"></a>
	...
	<div class="card card-product">
	  ...
	  <div class="card-body">
		...
		<a href="shop-single.html"><img class="card-img-top" src="/assets/frontend/template/img/products/4_small.jpg" alt="Card image cap"></a>
		...
		<div class="color-options">
		  ...
		  <label class="custom-control custom-radio custom-radio-color custom-control-inline">
			...
			<input type="radio" name="color-option2" class="custom-control-input" value="/assets/frontend/template/img/products/4_small.jpg" checked>
		  ...
		  <label class="custom-control custom-radio custom-radio-color custom-control-inline">
			...
			<input type="radio" name="color-option2" class="custom-control-input" value="/assets/frontend/template/img/products/4_small_blue.jpg">
		  ...
		  <label class="custom-control custom-radio custom-radio-color custom-control-inline">
			...
			<input type="radio" name="color-option2" class="custom-control-input" value="/assets/frontend/template/img/products/4_small_maroon.jpg">
