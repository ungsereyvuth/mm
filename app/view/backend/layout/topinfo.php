...
<header id="header">
    <div id="logo-group">
        ...
        <span id="logo"> <a href="/"><img src="<?=$pageData->label->system_title->sys->icon?>" title="<?=$pageData->label->system_title->sys->title?>" style="height: 30px;"></a> </span>
    ...
    <div class="pull-right">
        ...
        <?=$pageData->data->component->language_switch?>
        <!-- end multiple lang -->
