<?php
$listname='user_shoplist';
$formkey='newshop';
$formkey2='newshoptranslate';
?>
    ...
    <div class="row">
        ...
        <article class="col-sm-6 col-lg-5">
        	...
        	<div class="jarviswidget" id="<?=$formkey?>_wid" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false">
                <header>
                    <h2 class="khmerNormal"><i class="fa fa-user-plus"></i> New/Update <?=$pageData->label->listing->shops->title?> (<?=$pageData->lang->defaultName?>)</h2>   
                </header>
                <div>
                    <div class="jarviswidget-editbox">
                        <!-- This area used as dropdown edit box -->
