<?php
$listname='user_accommodationlist';
$formkey='newaccommodation';
$formkey2='newaccommodationtranslate';
?>
    ...
    <div class="row">
        ...
        <article class="col-sm-6 col-lg-5">
        	...
        	<div class="jarviswidget" id="<?=$formkey?>_wid" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false">
                <header>
                    <h2 class="khmerNormal"><i class="fa fa-user-plus"></i> New/Update <?=$pageData->label->listing->accommodations->title?> (<?=$pageData->lang->defaultName?>)</h2>   
                </header>
                <div>
                    <div class="jarviswidget-editbox">
                        <!-- This area used as dropdown edit box -->
